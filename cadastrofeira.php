  ...
  <body class="text-center">
    ...
    <div class="cover-container d-flex h-100 p-3 mx-auto flex-column">
      ...
      <main role="main" class="inner cover">
        ...
        <p class="lead">Cadastre seu grupo para a votação das feiras INFOTEC, FESEC e SILOG</p>
        <p class="lead">
          <a href="cadastrogrupo.php" class="btn btn-lg btn-secondary">Cadastrar Grupo</a>
